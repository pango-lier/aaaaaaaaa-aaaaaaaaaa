...
class GoogleMapSearch {
  ...
  async run({ fileLink }) {
    ...
    const found = await searchGoogleMap(this.page, {
      ...
      clickSendToPhoneScore: random(0, 0), //30 - 100 ms
      clickSaveScore: random(0, 0), //30 - 100 ms
      clickShareScore: random(100, 100), //30 - 100 ms
      clickReviewScore: random(100, 100), //30 - 100 ms
      clickAboutScore: random(100, 100), //30 - 100 ms
      clickOverViewScore: random(100, 100), //30 - 100 ms
      multiDelay: 1,
