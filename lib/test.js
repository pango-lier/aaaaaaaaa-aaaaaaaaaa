...
const test = async () => {
  ...
  try {
    ...
    const googleSearch = new TripadvisorSearch(pup);
    await googleSearch.run(
      ["hoi an"],
      "Attraction_Review-g298082-d4507121-Reviews-Hoi_An_Ancient_Town-Hoi_An_Quang_Nam_Province.html"
    );
