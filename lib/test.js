...
const test = async () => {
  ...
  try {
    ...
    const tripadvisorSearch = new TripadvisorSearch(pup);
    const tripadvisor = await randomParseTextToArray(
      "./helper/tripadvisor-search.txt"
    );
    await tripadvisorSearch.run([tripadvisor[0]], tripadvisor[1]);
