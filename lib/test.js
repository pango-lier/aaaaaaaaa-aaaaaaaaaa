...
const test = async () => {
  ...
  try {
  //   const aes=new DeSocket()
  //  const data= aes.en('test');
  //  console.log(aes.de(data));
   const page = await browser.newPage();
    ...
    // START GOOGLE SEARCH
    const googleSearch = new GoogleSearch(page);
    ...
    await googleSearch.run(["nhom kinh da lat"], domain);
    // END GOOGLE SEARCH
