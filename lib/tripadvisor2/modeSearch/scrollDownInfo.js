...
const scrollDownInfo = async (page, domain, scoreDown = 85, scrollFast = 3) => {
  ...
  switch (scrollFast) {
    case 1:
      current = await page.scrollRandUpDownScore(
        scoreDown,
        { delayMin: 20, delayMax: 50 },
        { stepMin: 40, stepMax: 520 },
        { loopMin: 1, loopMax: 5 }
      );
      break;
    case 2:
      current = await page.scrollRandUpDownScore(
        scoreDown,
        { delayMin: 50, delayMax: 700 },
        { stepMin: 40, stepMax: 130 },
        { loopMin: 1, loopMax: 2 }
      );
      break;
    default:
    case 3:
      current = await page.scrollRandUpDownScore(
        scoreDown,
        { delayMin: 50, delayMax: 800 },
        { stepMin: 40, stepMax: 150 },
        { loopMin: 1, loopMax: 2 }
      );
      break;
    case 4:
      current = await page.scrollRandUpDownScore(
        scoreDown,
        { delayMin: 50, delayMax: 900 },
        { stepMin: 40, stepMax: 170 },
        { loopMin: 1, loopMax: 1 }
      );
      break;
    case 5:
      current = await page.scrollRandUpDownScore(
        scoreDown,
        { delayMin: 50, delayMax: 1000 },
        { stepMin: 20, stepMax: 190 },
        { loopMin: 1, loopMax: 1 }
      );
      break;
    case 6:
      current = await page.scrollRandUpDownScore(
        scoreDown,
        { delayMin: 50, delayMax: 1100 },
        { stepMin: 40, stepMax: 210 },
        { loopMin: 1, loopMax: 1 }
      );
      break;
    case 7:
      current = await page.scrollRandUpDownScore(
        scoreDown,
        { delayMin: 50, delayMax: 1200 },
        { stepMin: 40, stepMax: 240 },
        { loopMin: 1, loopMax: 1 }
      );
      break;
    case 8:
      current = await page.scrollRandUpDownScore(
        scoreDown,
        { delayMin: 50, delayMax: 1400 },
        { stepMin: 40, stepMax: 270 },
        { loopMin: 1, loopMax: 1 }
      );
      break;
    case 9:
      current = await page.scrollRandUpDownScore(
        scoreDown,
        { delayMin: 50, delayMax: 1600 },
        { stepMin: 60, stepMax: 290 },
        { loopMin: 1, loopMax: 1 }
      );
      break;
    case 10:
      current = await page.scrollRandUpDownScore(
        scoreDown,
        { delayMin: 100, delayMax: 1800 },
        { stepMin: 50, stepMax: 310 },
        { loopMin: 1, loopMax: 1 }
      );
      break;
  }
  ...
  const links = await getSearchLinks('a[href*="/"]', page);
