...
const CLICK_IGNORE_GOOGLE_PHOTO ="#yDmH0d > div.llhEMd.iWO5td > div > div.g3VIld.Gx8bNc.eejsDc.Up8vH.J9Nfi.iWO5td > span > div > button";
...
class GooglePhoto {
  ...
  async importFile(paths) {
    try {
      ...
      if (!(await page.checkSelector(CLICK_IGNORE_GOOGLE_PHOTO)) === true){
