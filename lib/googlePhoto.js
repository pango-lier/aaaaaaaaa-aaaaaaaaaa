...
const CLICK_GOOGLE_PHOTO_SELECT = '.J3TAe > .rxangc > .U26fgb.JRtysb'; // ".J3TAe > .rxangc > .U26fgb > .I3EnF > .NlWrkb";
const CLICK_GOOGLE_PHOTO_SELECT2 = '.J3TAe > .rxangc > #ow18'; // ".J3TAe > .rxangc > .U26fgb > .I3EnF > .NlWrkb";
...
class GooglePhoto {
  ...
  async importFile(paths) {
    try {
      ...
      if ((await this.page.checkSelector(CLICK_GOOGLE_PHOTO_SELECT2)) === true) {
