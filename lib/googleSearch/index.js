        ...
        switch (mode) {
            ...
            case "random-optimize":
                if (page === 1) {
                    ...
                    const score = random(0, 100);
                    if (score < 10) page = 1;
                    else if (score < 14) page = 2;
                    else if (score < 17) page = 3;
                    else if (score < 93) page = 5;
                    else if (score < 95) page = 6;
                    else if (score < 97) page = 7;
                    else page = 8;
                    ...
                    else if (score < 32) page = 3;
                    else if (score < 35) page = 4;
                    else if (score < 95) page = 6;
                    else if (score < 97) page = 7;
                    else page = 8;
                }
