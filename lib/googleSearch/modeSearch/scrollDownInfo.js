...
const scrollDownInfo = async (page, domain, scoreDown = 85, scrollFast = 3) => {
    ...
    switch (scrollFast) {
        case 1:
            ...
            break;
        case 2:
            current = await page.scrollRandUpDownScore(scoreDown, { delayMin: 150, delayMax: 700 }, { stepMin: 20, stepMax: 60 }, { loopMin: 1, loopMax: 3 });
            break;
        default:
        case 3:
        ...
        case 5:
            ...
            break;
        case 6:
            current = await page.scrollRandUpDownScore(scoreDown, { delayMin: 100, delayMax: 1100 }, { stepMin: 10, stepMax: 350 }, { loopMin: 1, loopMax: 1 });
            break;
        case 7:
            current = await page.scrollRandUpDownScore(scoreDown, { delayMin: 150, delayMax: 1200 }, { stepMin: 10, stepMax: 400 }, { loopMin: 1, loopMax: 1 });
            break;
        case 8:
            current = await page.scrollRandUpDownScore(scoreDown, { delayMin: 100, delayMax: 1400 }, { stepMin: 10, stepMax: 450 }, { loopMin: 1, loopMax: 1 });
            break;
        case 9:
            current = await page.scrollRandUpDownScore(scoreDown, { delayMin: 150, delayMax: 1600 }, { stepMin: 10, stepMax: 500 }, { loopMin: 1, loopMax: 1 });
            break;
        case 10:
            current = await page.scrollRandUpDownScore(scoreDown, { delayMin: 150, delayMax: 1800 }, { stepMin: 10, stepMax: 550 }, { loopMin: 1, loopMax: 1 });
            break;
    }
