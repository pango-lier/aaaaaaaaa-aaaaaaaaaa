...
const scrollDownInfo = async (page, domain, scoreDown = 85, scrollFast = 3) => {
    ...
    switch (scrollFast) {
        case 1:
            current = await page.scrollRandUpDownScore(scoreDown, { delayMin: 100, delayMax: 600 }, { stepMin: 10, stepMax: 80 }, { loopMin: 1, loopMax: 4 });
            break;
        case 2:
            current = await page.scrollRandUpDownScore(scoreDown, { delayMin: 100, delayMax: 700 }, { stepMin: 20, stepMax: 90 }, { loopMin: 1, loopMax: 3 });
            break;
        default:
        case 3:
            current = await page.scrollRandUpDownScore(scoreDown, { delayMin: 100, delayMax: 800 }, { stepMin: 40, stepMax: 130 }, { loopMin: 1, loopMax: 2 });
            break;
        case 4:
            current = await page.scrollRandUpDownScore(scoreDown, { delayMin: 100, delayMax: 900 }, { stepMin: 40, stepMax: 170 }, { loopMin: 1, loopMax: 1 });
            break;
        case 5:
            current = await page.scrollRandUpDownScore(scoreDown, { delayMin: 100, delayMax: 1000 }, { stepMin: 20, stepMax: 250 }, { loopMin: 1, loopMax: 1 });
            break;
        case 6:
