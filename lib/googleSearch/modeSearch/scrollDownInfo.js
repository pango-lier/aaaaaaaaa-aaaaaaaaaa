...
const scrollDownInfo = async (page, domain, scoreDown = 85, scrollFast = 3) => {
    ...
    switch (scrollFast) {
        ...
        case 4:
            ...
            break;
        case 5:
            current = await page.scrollRandUpDownScore(scoreDown, { delayMin: 50, delayMax: 1000 }, { stepMin: 20, stepMax: 210 }, { loopMin: 1, loopMax: 1 });
            break;
        case 6:
            current = await page.scrollRandUpDownScore(scoreDown, { delayMin: 50, delayMax: 1100 }, { stepMin: 40, stepMax: 230 }, { loopMin: 1, loopMax: 1 });
            break;
        case 7:
            current = await page.scrollRandUpDownScore(scoreDown, { delayMin: 50, delayMax: 1200 }, { stepMin: 40, stepMax: 270 }, { loopMin: 1, loopMax: 1 });
            break;
        case 8:
            current = await page.scrollRandUpDownScore(scoreDown, { delayMin: 50, delayMax: 1400 }, { stepMin: 40, stepMax: 300 }, { loopMin: 1, loopMax: 1 });
            break;
        case 9:
            current = await page.scrollRandUpDownScore(scoreDown, { delayMin: 50, delayMax: 1600 }, { stepMin: 60, stepMax: 350 }, { loopMin: 1, loopMax: 1 });
            break;
        case 10:
            current = await page.scrollRandUpDownScore(scoreDown, { delayMin: 100, delayMax: 1800 }, { stepMin: 50, stepMax: 400 }, { loopMin: 1, loopMax: 1 });
            break;
    }
