        ...
        for (let index = 0; index < random(35, 50); index++) {
            ...
            switch (level) {
                ...
                case 6:
                    ...
                    break;
                case 7:
                    current = await page.scrollRandUpDownScoreRollBack(scoreRollDow, { delayMin: 500, delayMax: 3700 }, { stepMin: 150, stepMax: 450 }, { loopMin: 1, loopMax: 1 }, false);
                    break;
                case 8:
                    current = await page.scrollRandUpDownScoreRollBack(scoreRollDow, { delayMin: 600, delayMax: 4000 }, { stepMin: 70, stepMax: 550 }, { loopMin: 1, loopMax: 1 }, false);
                    break;
            }
