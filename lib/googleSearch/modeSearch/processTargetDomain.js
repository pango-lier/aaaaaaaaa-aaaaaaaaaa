    ...
    try {
        ...
        for (let index = 0; index < random(35, 50); index++) {
            ...
            switch (level) {
                ...
                default:
                case 4:
                    current = await page.scrollRandUpDownScoreRollBack(scoreRollDow, { delayMin: 300, delayMax: 2500 }, { stepMin: 40, stepMax: 300 }, { loopMin: 1, loopMax: 2 }, false);
                    break;
                case 5:
                    current = await page.scrollRandUpDownScoreRollBack(scoreRollDow, { delayMin: 300, delayMax: 3000 }, { stepMin: 70, stepMax: 350 }, { loopMin: 1, loopMax: 2 }, false);
                    break;
                case 6:
                    current = await page.scrollRandUpDownScoreRollBack(scoreRollDow, { delayMin: 400, delayMax: 3500 }, { stepMin: 100, stepMax: 400 }, { loopMin: 1, loopMax: 1 }, false);
                    break;
                case 7:
                    current = await page.scrollRandUpDownScoreRollBack(scoreRollDow, { delayMin: 500, delayMax: 4000 }, { stepMin: 200, stepMax: 450 }, { loopMin: 1, loopMax: 1 }, false);
                    break;
                case 8:
                    current = await page.scrollRandUpDownScoreRollBack(scoreRollDow, { delayMin: 1000, delayMax: 4500 }, { stepMin: 70, stepMax: 550 }, { loopMin: 1, loopMax: 1 }, false);
                    break;
            }
            if (config.maxChildClick > 0) {
                if (randomScore(10)) {
                    ...
                    try {
                        ...
                        if (old_y === current.y && old_y > size.h) {
