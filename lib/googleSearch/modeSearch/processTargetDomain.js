...
const processTargetDomain = async (page, link, level = 5, scoreRollDow = 85) => {
    ...
    switch (level) {
        ...
        case 6:
            ...
            break;
        case 7:
            await page.scrollRandUpDownScore(80, { delayMin: 500, delayMax: 3500 }, { stepMin: 200, stepMax: 600 }, { loopMin: 20, loopMax: 50 });
            break;
        case 8:
            await page.scrollRandUpDownScore(85, { delayMin: 1000, delayMax: 5500 }, { stepMin: 70, stepMax: 750 }, { loopMin: 25, loopMax: 40 });
            break;
    }
