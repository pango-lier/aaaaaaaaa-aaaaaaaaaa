        ...
        for (let index = 0; index < random(35, 50); index++) {
            ...
            switch (level) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    current = await page.scrollRandUpDownScoreRollBack(90, { delayMin: 400, delayMax: 3500 }, { stepMin: 100, stepMax: 400 }, { loopMin: 1, loopMax: 1 });
                    break;
                case 7:
                    current = await page.scrollRandUpDownScoreRollBack(90, { delayMin: 500, delayMax: 4000 }, { stepMin: 200, stepMax: 450 }, { loopMin: 1, loopMax: 1 });
                    break;
                case 8:
                    current = await page.scrollRandUpDownScoreRollBack(90, { delayMin: 1000, delayMax: 4500 }, { stepMin: 70, stepMax: 550 }, { loopMin: 1, loopMax: 1 });
                    break;
            }
