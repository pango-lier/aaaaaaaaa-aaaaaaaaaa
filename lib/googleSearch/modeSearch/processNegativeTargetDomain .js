...
const processNegativeTargetDomain = async (
  page,
  link,
  level = 5,
  scoreRollDow = 85,
        ...
        switch (level) {
          case 2:
            await page.scrollRandUpDownScoreRollBack(
              90,
              { delayMin: 200, delayMax: 600 },
              { stepMin: 120, stepMax: 600 },
              { loopMin: 1, loopMax: 2 }
            );
            break;
          case 3:
            await page.scrollRandUpDownScoreRollBack(
              scoreRollDow,
              { delayMin: 150, delayMax: 700 },
              { stepMin: 180, stepMax: 800 },
              { loopMin: 1, loopMax: 2 }
            );
            break;
          default:
          case 4:
            await page.scrollRandUpDownScoreRollBack(
              scoreRollDow,
              { delayMin: 250, delayMax: 750 },
              { stepMin: 230, stepMax: 900 },
              { loopMin: 1, loopMax: 2 }
            );
            break;
          case 5:
          ...
          case 6:
            await page.scrollRandUpDownScoreRollBack(
              80,
              { delayMin: 300, delayMax: 850 },
              { stepMin: 350, stepMax: 1100 },
              { loopMin: 1, loopMax: 2 }
            );
            break;
          case 7:
            await page.scrollRandUpDownScoreRollBack(
              85,
              { delayMin: 200, delayMax: 900 },
              { stepMin: 200, stepMax: 1200 },
              { loopMin: 1, loopMax: 2 }
            );
            break;
          case 8:
            await page.scrollRandUpDownScoreRollBack(
              80,
              { delayMin: 200, delayMax: 1000 },
              { stepMin: 450, stepMax: 1400 },
              { loopMin: 1, loopMax: 2 }
            );
            break;
        }
