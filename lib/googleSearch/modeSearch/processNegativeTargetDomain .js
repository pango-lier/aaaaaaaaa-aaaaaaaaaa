...
const processNegativeTargetDomain = async (page, link, level = 5, scoreRollDow = 85) => {
    await page.scrollRandUpDownScore(100, link, { delayMin: 500, delayMax: 900 }, { stepMin: 30, stepMax: 127 }, { loopMin: 2, loopMax: 4 });
    await page.delayRandomMs(800, 2000);
    console.log("processNegativeTargetDomain :" + link.href);
    await page.clickHref('a[href*="' + link.href + '"]');
    await page.delayRandomMs(2500, 4900);
    ...
    switch (level) {
        ...
        case 6:
            ...
            break;
        case 7:
            await page.scrollRandUpDownScore(70, { delayMin: 200, delayMax: 1200 }, { stepMin: 200, stepMax: 1200 }, { loopMin: 3, loopMax: 8 });
            break;
        case 8:
            await page.scrollRandUpDownScore(75, { delayMin: 200, delayMax: 1000 }, { stepMin: 450, stepMax: 1400 }, { loopMin: 4, loopMax: 10 });
            break;
    }
